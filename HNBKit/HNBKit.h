...
//! Project version string for HNBKit.
FOUNDATION_EXPORT const unsigned char HNBKitVersionString[];

// In this header, you should import all the public headers of your framework using statements like #import <HNBKit/PublicHeader.h>
